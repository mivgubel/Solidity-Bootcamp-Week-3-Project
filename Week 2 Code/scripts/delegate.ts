...
async function main() {
  ...
  /// @comment from Cody Reeves: Shouldn't we use process.argv to get arguments instead of hard coding wallet addresses?
  /// Also the 'delegates' and 'delegate' functions were never defined in the smart contract, so this code doesn't run anything yet
